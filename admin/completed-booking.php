...
if($ptype==1): echo "BASIC CLEANING (₱110.99)";endif;
if($ptype==2): echo "PREMIUM CLEANING (₱220.99)";endif;
if($ptype==3): echo "COMPLEX CLEANING (₱330.99)";endif;
