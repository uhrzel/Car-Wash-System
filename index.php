                ...
                <div class="owl-carousel">
                    <div class="carousel-item">
                        ...
                        <div class="carousel-text">
                            <h3>ADVANCE DATABASE & WEB SYSTEM</h3>
                    ...
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                ...
                                <h2><span>₱</span><strong>110</strong><span>.99</span></h2>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="price-item featured-item">
                            <div class="price-header">
                                ...
                                <h2><span>₱</span><strong>220</strong><span>.99</span></h2>
                            </div>
                            <div class="price-body">
                                <ul>
                                    <li><i class="far fa-check-circle"></i>Seats Washing</li>
                    ...
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                ...
                                <h2><span>₱</span><strong>330</strong><span>.99</span></h2>
                            </div>
                            <div class="price-body">
                                <ul>
                                    <li><i class="far fa-check-circle"></i>Seats Washing</li>
...
<form method="post">   
  <p>
            <select name="packagetype" required class="form-control">
                ...
                <option value="1">BASIC CLEANING (₱110.99)</option>
                 <option value="2">PREMIUM CLEANING (₱220.99)</option>
                  <option value="3 ">COMPLEX CLEANING(₱330.99)</option>
              </select>

          <p>
            <select name="washingpoint" required class="form-control">
                <option value="">Select Washing Address</option>
